...
#define R_DATA_PIN 6 //Data pin for WS281B RGB LED type for rear light
#define F_DATA_PIN 7 //Data pin for WS281B RGB LED type for rear light
CRGB Rleds[NUM_LEDS]; //Define the array of LEDs
CRGB Fleds[NUM_LEDS]; //Define the array of LEDs

const byte Brake = 4; //Brake Pin
const byte LI = 3; //Left Indicator Pin
const byte RI = 2; //Right Indicator Pin
...
//  if (ambLight <= 500){
//    ambLight = map(ambLight,0,1023,0,50);
...
//  }
//
//  if (ambLight <= 500 && digitalRead(Brake)==LOW){
//    ambLight = map(ambLight,0,1023,0,50);
//    headLightOn(ambLight);
//    brakeLight(50);
//  }else{
